        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                ...
                <p class="card-category"> Fluxo de caixa</p>
              </div>
              <div class="card-body">
                <div class="row">
...
$(document).ready(function() {    
    ...
    var table = $('#datatable').DataTable( {
      ...
      $("#forms").on('click', '#formsBalance', function(event) {
