      ...
      $(document).on('click', '#btnShow', function(event) {
          ...
          $.ajax({
              ...
              success: function(result) {
                ...
                $("#id").val(result.data.team.id);
                $("#name").val(result.data.team.name);                  

                $("#championship_id").val(result.data.team.championship_id).change();
                $("#categoria_id").val(result.data.team.categoria_id).change();
                
                $('#driver_id').val(result.data.TeamsDriver);
